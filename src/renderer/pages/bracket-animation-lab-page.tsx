  ...
  return (
    <div className="bracket-lab">
      ...
      <section className="bracket-lab__toolbar panel">
        ...
        <button className="button button--accent" type="button" onClick={playSequence}>
          Play Full Handoff
        </button>
      </section>
      ...
      <section className="bracket-lab__phase-panel panel">
        ...
        <div className="bracket-lab__phase-buttons">
          {labPhases.map((candidate) => (
            <button
              key={candidate.id}
              className={`button button--ghost${phase === candidate.id ? " bracket-lab__phase-button--active" : ""}`}
              type="button"
              onClick={() => {
